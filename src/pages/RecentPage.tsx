      ...
      <div className="bg-white shadow-sm border-b border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex flex-col space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4 sm:items-center sm:justify-between">
            <h1 className="text-2xl font-bold text-slate-900">📊 Recent Purchases</h1>
            ...
            <div className="flex flex-col space-y-2 sm:flex-row sm:space-y-0 sm:space-x-4 sm:items-center">
              ...
              <div className="relative">
                ...
                <select
                  ...
                  className="pl-10 pr-8 py-2 border border-slate-300 rounded-md focus:ring-teal-500 focus:border-teal-500 bg-white w-full sm:w-48"
                >
                ...
                <div className="bg-white rounded-lg shadow-sm border border-slate-100">
                  <div className="px-6 py-4 border-b border-slate-100">
                    <div className="flex items-center justify-between">
                      <h3 className="text-md font-medium text-slate-900">Shopping Trip</h3>
                      <span className="text-sm text-slate-500">{datePurchases.length} items</span>
                    </div>
                  </div>
